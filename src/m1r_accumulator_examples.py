...
#                  if math.cos(r) > 0:  should be r + k instead of just r
...
#
#                   The underscore is just a placeholder, like k, that makes it loop, but
#                   shows that there is no plan of using it.
#
