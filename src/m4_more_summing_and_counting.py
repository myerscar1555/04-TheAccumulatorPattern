...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 2
    answer = count_cosines_from(2, 11, .5)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
    # Test 3:
    expected = 1
    answer = count_cosines_from(1, 4, -.03)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
    # Test 4:
    expected = 0
    answer = count_cosines_from(8, 9, 0.1)
    ...
    # Test 6:
    expected = 7
    answer = count_cosines_from(11, 21, 0)
...
def run_test_sum_unit_fractions_from():
    ...
    print('       actual:  ', answer)
    # Test 3:
    expected = 0.38202  # This is APPROXIMATELY the correct answer.
